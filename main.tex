...
\begin{frame}{Bayesian Neural Nets}
  ...
  Bayesian NNs need \imp{random samples of their weights} to be propagated through the network. This has to be \imp{built into the computational graph}.
...
\begin{frame}{Bayesian Neural Nets}
  ...
  \begin{columns}
    ...
    These samples have to be built into the graph since the \imp{learning objective} is part of the graph.
